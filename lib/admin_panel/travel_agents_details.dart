...
class travelagentsdetails extends StatefulWidget {
  @override
  _travelagentsdetailsState createState() => _travelagentsdetailsState();
}

class _travelagentsdetailsState extends State<travelagentsdetails> {
  String name = "name loading...";
  String email = "email loading...";
// for all user details from firestore
  void getData() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("All Travel Agents Data "),
        backgroundColor: MyColors.myColor,
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream:
            FirebaseFirestore.instance.collection("travelagents").snapshots(),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(data['name'], style: myTextStyle),
                        subtitle: Row(
                          children: [
                            Column(
                                            ...
                                            TextButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      "Travel Agent deleted succesfully ",
                                                    ),
                                                  ),
                                                );
                                              },
...
class travelagentstails extends StatefulWidget {
  @override
  _travelagentsdetailsState createState() => _travelagentsdetailsState();
}

class _travelagentsdetailsState extends State<travelagentstails> {
  ...
  void searchCustomers(String query) {
    ...
    if (query.isNotEmpty) {
      FirebaseFirestore.instance
        ...
        print("Failed to search travelagent: $error");
      });
    } else {
      setState(() {
        filteredCustomers = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("All travelagents Data "),
        backgroundColor: MyColors.myColor,
        leading: IconButton(
